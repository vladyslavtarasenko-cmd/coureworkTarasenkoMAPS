(function() {
    ...
    function sendNewMessage() {
        ...
        saveChats();
        closeNewChatModal();
        if (document.getElementById('newChatRecipient')) document.getElementById('newChatRecipient').value = '';
        if (document.getElementById('newChatMessage')) document.getElementById('newChatMessage').value = '';
        renderChatList();
        openChat(newChat.id);
    }
